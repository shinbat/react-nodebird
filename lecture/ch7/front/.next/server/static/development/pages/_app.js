...
/***/ "../../ch5/front/reducers/user.js":
/*!**********************************************************************!*\
  !*** D:/workspace/react-nodebird/lecture/ch5/front/reducers/user.js ***!
  \**********************************************************************/
...
var UserProfile = function UserProfile() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(antd__WEBPACK_IMPORTED_MODULE_1__["Card"], {
    actions: [react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      key: "twit"
    }, "\uC9F9\uC9F9", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), me.Posts.length), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      key: "following"
...
var NodeBird = function NodeBird(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_9__["Provider"], {
    store: store
  ...
  })), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_AppLayout__WEBPACK_IMPORTED_MODULE_11__["default"], null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Component, pageProps)));
};
...
function loadUserPostsAPI(userId) {
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("/user/".concat(userId || 0, "/posts"));
}
...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _reducers_user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../reducers/user */ "./reducers/user.js");
/* harmony import */ var _ch5_front_reducers_user__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../ch5/front/reducers/user */ "../../ch5/front/reducers/user.js");
...
function loadUserAPI(userId) {
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(userId ? "/user/".concat(userId) : '/user/', {
    withCredentials: true // client에서 요청보낼 때는 browser가 cookie를 동봉한다

  }); // ssr일 때는 browser가 없어서 직접 넣어준다
}
    ...
    while (1) {
      switch (_context17.prev = _context17.next) {
        ...
        case 3:
          ...
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["put"])({
            // put은 dispatch와 동일
            type: _ch5_front_reducers_user__WEBPACK_IMPORTED_MODULE_4__["REMOVE_FOLLOWER_SUCCESS"],
            data: _result6.data
          });
        ...
        case 8:
          ...
          _context17.next = 13;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["put"])({
            type: _ch5_front_reducers_user__WEBPACK_IMPORTED_MODULE_4__["REMOVE_FOLLOWER_FAILURE"],
            error: _context17.t0
          });
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function watchRemoveFollower$(_context18) {
    while (1) {
      switch (_context18.prev = _context18.next) {
        case 0:
          _context18.next = 2;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["takeEvery"])(_ch5_front_reducers_user__WEBPACK_IMPORTED_MODULE_4__["REMOVE_FOLLOWER_REQUEST"], removeFollower);
